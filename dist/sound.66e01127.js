...
async function getAudio() {
  ...
  analyzer.fftSize = 2 ** 10; //   pull the data oof the audio
...
function drawTimeData(timeData) {
  ...
  ctx.clearRect(0, 0, WIDTH, HEIGHT); // 2. Set some canvas drawing
...
function drawFrecuency(frequencyData) {
  ...
  frequencyData.forEach(amount => {
    ...
    const barHeight = HEIGHT * percent * 1.2; // TODO: conver the colour to hsl
